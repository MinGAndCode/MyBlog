...
VALUES
	...
	(6,'my github','https://github.com/MinGAndCode','link',NULL,0,0);
...
VALUES
	...
	('site_keywords','MinG Blog',NULL),
	('site_description','MinG Blog',NULL),
	('site_record','','备案号');
...
VALUES
	(1, 'admin', 'a66abb5684c45962d887564f08346e8d', '158563862@qq.com', NULL, 'admin', 1490756162, 0, 0, 'visitor');